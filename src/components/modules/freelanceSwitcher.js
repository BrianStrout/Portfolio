...
const freelanceClicker = (e) => {
  ...
  switch (e.target.id) {
    ...
    <p class="handy">Does your restaurant, cafe, or bar want a web based menu system you can update on a google spreadsheet from your phone?  This is what it could look like. :)</p>
    
  </li>
  <li>  <div class="linkOutTo" id="winter"></div>
    <h2 class="words-header">Motion Based Landing Page</h2>
    <p class="handy">Capture your audiences attention with a landing page that has animated elements made from your own art or photos</p>
    </li>
  <li>  <div class="linkOutTo" id="mookie"></div>
    <h2 class="words-header">Playfully introduce your shop</h2>
    <p class="handy">Want to set a welcoming vibe, let's set that up with giving your page an actual fun intro and simple style</p>
    </li>
  <li>  <div class="linkOutTo" id="Masha"></div>
    <h2 class="words-header">Proper Introductions</h2>
    <p class="handy">Bring heads to a stop with elegant animation intros to display your fashion or personal modeling</p>
    </li>
    <li>  <div class="linkOutTo" id="Masha"></div>
